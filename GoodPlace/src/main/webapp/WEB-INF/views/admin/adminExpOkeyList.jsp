...
<body>
	<div id="wrap">
        ...
        <div id="contents" >
            <div id="tab">
                <button class="off lt_tab" onclick="location.href='aExpWaitList.ex?currentPage=1'">승인대기목록</button>
                <button class="on gt_tab" onclick="location.href='aExpOkayList.ex?currentPage=1'">체험승인목록</button>
            </div>
            <div class="sitemap">
