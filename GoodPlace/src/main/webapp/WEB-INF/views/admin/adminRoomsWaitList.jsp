...
<body>
	<div id="wrap">
        ...
        <div id="contents" >
            <div id="tab">
                <button class="on lt_tab" onclick="location.href='aRoomsWaitList.ro?currentPage=1'">승인대기목록</button>
                <button class="off gt_tab" onclick="location.href='aRoomsOkeyList.ro?currentPage=1'">숙소승인목록</button>
            </div>
            <div class="sitemap">
