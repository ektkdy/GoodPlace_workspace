...
<body>
    <div id="wrap">
        ...
        <div id="contents" >
            ...
            <div class="sitemap">
                <a href="#"><span style="width: 30px;height: 30px;">이벤트수정</span></a>
            </div>
            <div class="con" style="color:#000;">
                <span id="page_title"><img src="${pageContext.request.contextPath}/resources/images/admin/집로고.jpg" style="vertical-align: middle;"><p class="title_tt">이벤트수정</p></span>
                                <div class="con2">
