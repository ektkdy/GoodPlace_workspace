...
<style>
        ...
        .common_tb thead tr th , .common_tb tbody tr th{background-color:#f1f1f1; font-size: 18px; color:#333; padding: 10px 0; text-align: center;
                           border-top: 1px solid #bebebe; border-bottom:1px solid #bebebe;}
        .common_tb thead tr td{border-bottom:1px solid rgb(241, 241, 241); font-size: 15px;}
	                        ...
	                        <thead>
	                            <tr>
	                                ...
	                                <td class="category" colspan="3" width="600px">
	                                    <input type="radio" name="inqCategory" value="1"> 일반문의
	                                    <input type="radio" name="inqCategory" value="2"> 상품문의
	                                    <input type="radio" name="inqCategory" value="3"> 취소, 환불
	                        ...
	                        <tbody>             	
	                            <tr>
	                                ...
	                                <td colspan="3" style="text-align: left;">
	                                    <input type="text" name="inqReTitle" style="width: 400px; margin-left: 20px;" required>
	                                </td>
	                            </tr>
	                            <tr class="roomsDisable disable">
	                                <th>신고숙소</th>
	                                <td  style="text-align: left;">
	                                    <select class="requiredOption" name="roNo" style="margin-left: 20px;">
	                                        <option value="">숙소를 선택해주세요</option>
	                                        <c:forEach items="${ myRoomPay }" var="myRoomPay">
	                                        	<input type="hidden" name="rpNo" value="${ rpNo }">
	                                        	<option value="${ myRoomPay.roNo }">숙소이름 : ${ myRoomPay.roomsTitle } /  다녀간 날짜 : ${startDays} ~ ${ endDays }</option>
	                                        </c:forEach>
	                                    </select>
	                                </td>
	                            </tr>
	                            <tr style="width: 100px;">
	                                <td colspan="4" style="height: 200px;">
	                                    <textarea name="inqueryContent" style="width: 100%; height: 100%;" required></textarea>
	                                </td>
	                            </tr>
	                            <tr>
	                                <td colspan="4">
	                                    <div>
	                                        <input type="submit" class="Btn" value="1:1문의하기" style="text-align: center; float: none; margin-top: 0px;">
	                                    </div>
	                                </td>
	                            </tr>
                        	</tbody>
