...
<head>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=68f4fd3b188d5ebb8b7eba2636eb2d15&libraries=services"></script>
    ...
    mapOption = {
        center: new kakao.maps.LatLng(37.551074, 126.987456), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };  
