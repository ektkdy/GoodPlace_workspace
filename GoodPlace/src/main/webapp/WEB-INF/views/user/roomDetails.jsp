    ...
    <div id="content">
            <div style="width:70%;">
                ...
                <div class="swiper-container" style="width:80%;  height:430px; margin:0 10%; position:relative; z-index:1;">
                    ...
                    <div class="swiper-slide"><img src="../img/street.jpg" width="100%" height="100%"></div>
                ...
                <div style="width:80%; margin:0 10%;">
                    ...
                    <div style="width:75%;" class="marginBottom_60px">
                        <div style="margin-bottom: 28px;" class="fullWidth marginBottom_40px">
                            <div div style="width:40%;"><h2 class="pointColor">체크인 시간</h2></div><div div style="width:60%;"><h2 class="pointColor">13:00</h2></div>
                            <br><br>
                            <div div style="width:40%;"><h2 class="pointColor"  >체크아웃 시간</h2></div><div div style="width:60%;"><h2 class="pointColor">11:00</h2></div>
                        </div>
                        <div class="fullWidth">
                            <h3>특이사항</h3><br>
                            <p>
