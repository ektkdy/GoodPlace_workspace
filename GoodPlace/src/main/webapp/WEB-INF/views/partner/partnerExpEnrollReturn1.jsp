...
<style>
    ...
    *{font-family: 'Noto Sans KR', sans-serif;}
    ...
    /* 거절div */
    #comment{width:900px; padding:20px; margin-top: 50px; margin-bottom: 50px; background: #f8f8f8; border:1px solid #f1f1f1; margin-bottom:50px;}
            ...
            <div id="comment">
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding:0px;"><input type="text" value="적절하지 못한 내용" readonly></td>
                    </tr>
                    <tr>
                        <td style="padding:0px; font-size:20px;"><p>거절상세</p></td>
                        <td style="padding:0px"><textarea id="" name="" readonly>사유입니다</textarea></td>
                    </tr>
                </table>
