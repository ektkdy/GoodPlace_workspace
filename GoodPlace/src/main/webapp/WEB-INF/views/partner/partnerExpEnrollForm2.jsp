	            ...
	            <div id="stepOne">
	                ...
	                <table>
	                    ...
	                    <tr>
	                        <th>* 최대 인원수</th>
	                        <td>
	                            <input type="number" class="maxPeople" name="maxPeople" min="1" max="10" required style="width:100px;margin-right:5px;">명
	                            <h5>• 최소 인원수는 1명입니다. 한 회차당 최대 10명까지 가능합니다.</h5>
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>* 체험 시간</th>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            ...
	                            <input type="checkbox" id="noSupplies" name="supplies" value="장비포함">
